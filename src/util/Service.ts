...
export default class Service {
  static _name = `whatsapp`;
  static crid = process.env.URL_PIECE;
  static port = process.env.PORT;
  static url = `https://${Service._name}-${Service.crid}`;
   ...
   */
  static listen() {
    console.log(`<----------${Service._name} service is alive on ${Service.port}---------->`);
  }
